...
[Here](https://taylyrics.streamlit.app/) is the link to the game. You can explore the associated [GitHub repository](https://github.com/jasminex21/tayLyrics) for further details. Good luck and have fun!

## Eventual Aim
Because each artist's songs and lyrics can be obtained programmatically from [genius.com](genius.com), my eventual aim is to provide an interface where fans of any artist can play their favorite artist's lyrics-guessing game. **tayLyrics** is the first of many such games that will be provided. Each game will be customized to be unique to the artist - for example, its name may be a pun related to the artist (e.g. **tayLyrics**), or it may have themes based on colors of the artist's album covers. 
